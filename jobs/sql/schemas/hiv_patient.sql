...
(
    ...
    art_dispensing_start_date         DATE,
    first_art_dispensing_regimen      TEXT,
    art_order_start_date              DATE,
    initial_art_regimen_order         TEXT,
    art_start_date                    DATE,
    months_on_art                     FLOAT,
    ...
    latest_biometrics_reference_code  VARCHAR(50),
