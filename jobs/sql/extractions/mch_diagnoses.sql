...
update temp_mch_diagnoses tm set abortion = if(diagnosis_concept in (concept_from_mapping('CIEL', '120295'), concept_from_mapping('PIH', '7697'), concept_from_mapping('CIEL', '162206')), @yes, @no);
update temp_mch_diagnoses tm set abortion_with_sepsis = if(diagnosis_concept = concept_from_mapping('CIEL', '150746'), @yes, @no);
...
update temp_mch_diagnoses tm set cervical_cancer = if(diagnosis_concept = concept_from_mapping('CIEL', '116023'), @yes, @no);

update temp_mch_diagnoses tm set cervical_laceration = if(diagnosis_concept = 
concept_from_mapping('CIEL', '145804'), @yes, @no);

update temp_mch_diagnoses tm set complete_abortion = if(diagnosis_concept = 
concept_from_mapping('CIEL', '120295'), @yes, @no);
...
concept_from_mapping('PIH', '7696'), @yes, @no);
...
concept_from_mapping('PIH', '7252'), @yes, @no);
...
= concept_from_mapping('PIH', '7993'), @yes, @no);
