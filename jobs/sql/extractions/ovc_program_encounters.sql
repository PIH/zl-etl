...
INSERT INTO ovc_encounters (person_id, encounter_id, encounter_date, date_entered, user_entered)
(
SELECT person_id, o.encounter_id, DATE(encounter_datetime), e.date_created, username(e.creator)
