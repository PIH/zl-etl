...
obs_from_group_id_value_numeric(o.obs_id,'PIH','9075')  duration,
obs_from_group_id_value_coded(o.obs_id,'PIH','6412','en') duration_unit,
obs_from_group_id_value_numeric(o.obs_id,'PIH','9073')  quantity_per_dose,
obs_from_group_id_value_text(o.obs_id,'PIH','9074')  dose_unit,
obs_from_group_id_value_coded(o.obs_id,'PIH','9363','en')  frequency,
obs_from_group_id_value_numeric(o.obs_id,'PIH','9071') quantity_dispensed,
obs_from_group_id_value_text(o.obs_id,'PIH','9072') prescription
FROM obs o
INNER JOIN encounter e ON o.encounter_id = e.encounter_id AND e.encounter_type = @enc_type
WHERE  o.concept_id = concept_from_mapping('PIH','9070')
AND o.voided =0
AND e.voided =0
ORDER BY obs_id ASC;
...
SELECT e.patient_id, e.encounter_id, d.name, openboxesCode(o.value_drug) drug_openboxes_code
FROM obs o 
INNER JOIN encounter e ON o.encounter_id = e.encounter_id AND e.encounter_type = @enc_type
...
INNER JOIN drug_name dn ON am.encounter_id=dn.encounter_id AND am.patient_id=dn.patient_id
